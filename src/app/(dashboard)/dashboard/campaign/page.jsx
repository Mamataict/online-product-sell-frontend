    ...
    <div className="max-w-3xl p-4 bg-white rounded-md shadow-md">
      <div>
        <div className="flex">
          ...
          <PermissionGuard permission={"campaign.store"}>
            <FontAwesomeIcon
              icon={faPlus}
              ...
              <tr key={campaign.id} className="border-b border-gray-200">
                ...
                <td className="p-4 border-b border-gray-200 flex gap-4">
                  {campaign.details.length > 0 && (
                    <>
                      <Link
                        href={`/dashboard/campaign/${campaign.id}/details`}
                        className="text-blue-600 hover:underline"
                      >
                  ...
                  <Link
                    href={`/dashboard/campaign/${campaign.id}/details/new`}
                    className="text-blue-600 hover:underline"
                  >
                    New?
                  </Link>
                ...
                <td className="flex gap-2 p-4 border-b border-gray-200">
                  <Link
                    href={`/dashboard/campaign/edit/${campaign.id}`}
                    className="text-blue-600 hover:underline"
                  >
                    Edit
                  </Link>
