    ...
    <div className="max-w-3xl p-4 bg-white rounded-md shadow-md">
      ...
      <div className="overflow-x-auto">
        <div className="pl-10 py-5">
          Total Discount:{" "}
          <span className="font-bold">{total_discount.toFixed(2)}৳</span>
        </div>
                ...
                <tr key={discount_info.id} className="border-b border-gray-200">
                  ...
                  <td className="p-4 border-b border-gray-200">
                    {discount_info.campaign.discount_type === "percentage" ? (
                      <span>
                        {(
                          (100 * Number(discount_info.payable_price)) /
                          (100 - Number(discount_info.campaign.discount))
                        ).toFixed(2)}
                      </span>
                    ) : (
                      <span>
                        {(
                          Number(discount_info.payable_price) +
                          Number(discount_info.campaign.discount)
                        ).toFixed(2)}
                        ৳
                      </span>
                    )}
