...
import CheckBox from "../features_cus/CheckBox";
        ...
        <table className="table-auto w-full text-left">
          <thead>
            <tr>
              ...
              <th className="p-4 border-b border-gray-200">Branch Code</th>
              <th className="p-4 border-b border-gray-200">Address</th>
              {(campaign_details_id || branch_assign) && (
                <th className="p-4 border-b border-gray-200">Assignment ({branch_assign ? 'Branch' : 'Campaign'})</th>
              )}
            ...
            {branches.map((branch) => (
              <tr key={branch.id} className="border-b border-gray-200">
                ...
                {campaign_details_id && (
                  <td className="p-4 border-b border-gray-200">
                    <CheckBox
                      checked={branch?.campaign_details?.length > 0}
                      onChange={() => onAssign(branch.id)}
                    />
                  </td>
                )}
                ...
                <td className=" p-4 border-b border-gray-200">
                  <div className="flex gap-2">
                    <Link
                      href={`/dairy_fresh/home/branch/edit/${branch.id}`}
